...
export default function AddBoliHead() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch('https://jain-temple.onrender.com/v1/boliDetail/createBoliHead', {
                method: 'POST',
                headers: {
            ...
            if (response.ok) {
                toast.success(`Boli Head Added Successfully`); // Use toast for success message
        ...
        <div className="container mx-auto p-4 relative">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                <div className="relative">
                    <label htmlFor="donationType" className="block mb-2">Boli Head</label>
                    <input
                        type="text"
                        id="donationType"
                        value={donationType}
