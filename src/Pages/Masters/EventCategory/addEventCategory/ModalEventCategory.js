...
import AddEventCategories from '.';

const ModalEventCategory = ({ isOpen, onClose, onRefresh }) => {
            ...
            >
                <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    <div className="p-4 md:p-5 space-y-4">
                        <AddEventCategories onSuccess={handleSignUpSuccess} />
                    </div>
                </div>
            </div>
        </div>
...
export default ModalEventCategory;
