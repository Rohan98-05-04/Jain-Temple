...
import ModalConfirmDelete from "./ModalDeleteGallery";
import ModalUpdateGallery from "./UpdateGallery/ModalUpdateGallery";
...
const Gallery = () => {
  ...
  const handleDelete = async () => {
    ...
    setIsLoading(true);
    const response = await fetch(
      `${API_BASE_URL}/gallery/deleteGallery/${Id}`,
      {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
            ...
            <table className="min-w-full text-left border border-gray-300">
              <thead className="bg-gray-100">
                <tr>
                  ...
                  <th className=" w-32py-2 px-4 border-b">Action</th>
                </tr>
              </thead>
              <tbody>
