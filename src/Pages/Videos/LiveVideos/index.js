...
const LiveVideos = () => {
  ...
  const fetchEvents = async () => {
    ...
    const response = await fetch(
      `${API_BASE_URL}/liveDarshan/getAllLiveDarshans?page=${activePage}&size=${size}&search=${search}`,
      {
        method: "GET",
        headers: {
  ...
  const handleDelete = async () => {
    ...
    setIsLoading(true);
    const response = await fetch(
      `${API_BASE_URL}/liveDarshan/deleteLiveDarshan/${Id}`,
      {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
  ...
  return (
    <div className="donarPage ">
      ...
      <div className="donarDetailMainPage">
        <Section>
          <h2 className="text-2xl font-bold mb-4">Live Bhajan</h2>
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full text-left border border-gray-300">
              <thead className="bg-gray-100">
                <tr>
                  <th className="w-48 py-2 px-4 text-nowrap border-b">
                    S. No.
                  </th>
