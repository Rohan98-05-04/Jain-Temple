...
import ViewBoliVoucher from './viewBoliVoucher';

const ModalViewBoliVoucher = ({ isOpen, onClose, BoliLedgerId }) => {
            ...
            >
                <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    <div className="p-4 md:p-5 space-y-4">
                        <ViewBoliVoucher BoliLedgerId={BoliLedgerId} />
                    </div>
                </div>
            </div>
        </div>
...
export default ModalViewBoliVoucher;
