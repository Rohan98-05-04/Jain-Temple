...
import EditBoliLedger from './updateBoliLedger';

const ModalEditBoliLedger = ({ isOpen, onClose, BoliLedgerId }) => {
            ...
            >
                <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    <div className="p-4 md:p-5 space-y-4">
                        <EditBoliLedger BoliLedgerId={BoliLedgerId} />
                    </div>
                </div>
            </div>
        </div>
...
export default ModalEditBoliLedger;
