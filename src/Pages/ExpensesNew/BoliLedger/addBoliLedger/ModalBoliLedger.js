...
import AddBoliLedger from './addLedger';

const ModalBoliLedger = ({ isOpen, onClose }) => {
        ...
        >
            ...
            >
                <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    <div className='py-4 text-center text-2xl font-semibold'>Add Expense Ledger</div>
...
export default ModalBoliLedger;
