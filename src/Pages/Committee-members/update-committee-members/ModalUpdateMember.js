...
import UpdateCommitteeMembers from '.';

const ModalMemberUpdate = ({ isOpen, onClose, eventId, onRefresh }) => {
            ...
            >
                <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    <div className="p-4 md:p-5 space-y-4">
                        <UpdateCommitteeMembers eventId={eventId} onSuccess={handleSignUpSuccess} />
                    </div>
                </div>
            </div>
        </div>
...
export default ModalMemberUpdate;
